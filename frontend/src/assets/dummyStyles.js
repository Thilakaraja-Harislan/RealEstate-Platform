...
export const wishlistStyles = {
  loaderFullPage: "loader-full-page",
  loader: "loader",
  pageContainer: "bg-bg-alt min-h-screen pt-2",
  mainContainer: "container fade-in pt-2 pb-12 px-4 md:px-8 ml-30",
  ...
  gridContainer: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center justify-center max-w-[1280px] mx-auto",
...
export const chatMessagesStyles = {
  ...
  chatContainerNonSeller: "h-[calc(100vh-80px)] pt-0",

  // Chat wrapper
  chatWrapper: "flex flex-1 bg-[#e8f3ee] font-sans relative overflow-hidden mt-0 md:mt-0",

  // Sidebar
  sidebar: "w-full absolute inset-0 z-10 transition-transform duration-300 lg:relative lg:w-[350px] shrink-0 bg-[#f2f7f5] border-r border-[#d6e4df] flex flex-col lg:translate-x-0",
  sidebarHidden: "-translate-x-full lg:-translate-x-0 hidden lg:flex",
  sidebarHeader: "p-5 border-b border-[#d6e4df] bg-[#eef4f1]",
  sidebarTitle: "m-0 text-xl font-bold text-[#112a1f]",
  sidebarContent: "flex-1 overflow-y-auto bg-[#f2f7f5]",
  emptyConversations: "flex-1 flex flex-col items-center justify-center text-[#8da399] text-center p-10 bg-[#f2f7f5]",
  emptyIcon: "w-20 h-20 mb-5 opacity-50 text-[#0d6e59]",
  conversationItem: "p-[15px_20px] flex items-center gap-3 cursor-pointer transition-colors duration-200 border-b border-[#e2ede8] hover:bg-[#dcece6] group",
  conversationItemActive: "bg-[#bde8d9] border-r-[3px] border-r-primary",
  avatar: "w-9 h-9 md:w-12 md:h-12 rounded-full bg-primary text-white flex items-center justify-center font-bold text-[0.9rem] md:text-base overflow-hidden",
  avatarImg: "w-full h-full object-cover",
  conversationInfo: "flex-1 min-w-0",
  conversationName: "font-semibold text-[#112a1f] mb-1 whitespace-nowrap overflow-hidden text-ellipsis",
  conversationPreview: "text-[0.85rem] text-[#4d6156] whitespace-nowrap overflow-hidden text-ellipsis",
  deleteChatButton: "bg-transparent border-none text-[#8da399] p-2 rounded-lg cursor-pointer opacity-100 md:opacity-0 transition-all duration-200 flex items-center justify-center hover:text-red-500 hover:bg-red-100 md:group-hover:opacity-100",

  // Chat area
  chatArea: "absolute inset-0 z-[5] lg:relative lg:flex-1 lg:z-auto flex flex-col bg-[#e8f3ee] w-full",
  chatHeader: "p-[10px_15px] md:p-[15px_25px] bg-[#dcece6] sticky md:relative top-0 z-20 border-b border-[#c8dad3] flex items-center justify-between",
  chatHeaderLeft: "flex items-center gap-3",
  backButton: "flex lg:hidden mr-2.5 bg-[#cbdfd6] border-none p-1.5 rounded-full text-[#112a1f]",
  chatPartnerName: "font-bold text-[#112a1f]",
  messagesArea: "p-[15px] pb-[80px] md:p-[25px] md:pb-[25px] overflow-y-auto flex-1 flex flex-col gap-[15px] bg-[#e8f3ee]",
  messageBubble: "max-w-[85%] md:max-w-[70%] p-[12px_18px] rounded-[20px] text-[0.95rem] leading-[1.5] relative",
  messageOwn: "self-end bg-primary text-white rounded-br-[4px] shadow-[0_4px_12px_rgba(13,110,89,0.25)]",
  messageOther: "self-start bg-[#d2eadb] text-[#1b3a24] rounded-bl-[4px] shadow-[0_4px_12px_rgba(13,110,89,0.06)]",
  ...
  deleteMessageButton: "bg-transparent border-none text-[#4d6156] cursor-pointer p-0.5 rounded transition-all duration-200 mt-0.5 hover:text-red-500",
  messageTime: "text-[0.75rem] mt-1.5 opacity-70 block",
  messageForm: "p-[12px_15px] md:p-[20px_25px] bg-[#dcece6] sticky md:relative bottom-0 border-t border-[#c8dad3] flex gap-[15px] items-center",
  messageInput: "flex-1 min-w-0 border border-[#c8dad3] bg-[#f4f9f7] rounded-[30px] p-[12px_25px] outline-none text-[0.95rem] text-[#112a1f] transition-colors duration-200 focus:border-primary",
  sendButton: "bg-primary text-white border-none w-[45px] h-[45px] rounded-full cursor-pointer flex items-center justify-center transition-all duration-200 text-xl hover:bg-[#0a5c4a] hover:scale-105 active:scale-95 shrink-0",
  sendIcon: "rotate-90",
  noChatSelected: "flex-1 flex flex-col items-center justify-center text-[#8da399] text-center p-10 bg-[#e8f3ee]",
  noChatIcon: "w-20 h-20 mb-5 opacity-40 text-[#0d6e59]",
  noChatTitle: "font-bold text-[#112a1f]",
};

export const contactStyles = {
  // Layout
  container: "min-h-screen bg-[#f8fafc] pt-2",
  mainContainer: "container pt-2 pb-16 px-6 max-w-[1000px] mx-auto",
  ...
  contactInfoCard: "card-premium p-8 bg-[#0a4a3c] text-white shadow-lg shadow-primary/10 border border-[#0d6e59]/30",
  contactItem: "flex items-center gap-4",
  contactItemMarginBottom: "mb-6",
  contactIconWrapper: "w-10 h-10 rounded-xl bg-white/10 text-white flex items-center justify-center border border-white/20",
  contactIconWrapperAlt: "w-10 h-10 rounded-xl bg-white/10 text-white flex items-center justify-center border border-white/20",
  contactTitle: "font-bold text-base text-[#d1fae5]",
  contactDetail: "text-[#a7f3d0] text-[0.9rem]",

  // Quick support card
  quickSupportCard: "card-premium h-[200px] bg-[#0d6e59] text-white flex flex-col justify-center items-center p-8 text-center border border-[#0a4a3c]/30",
...
export const profileStyles = {
  containerWrapper: (role) => role !== 'seller' ? 'bg-bg-alt min-h-screen pt-2' : 'bg-transparent min-h-auto',
  mainContainer: (role) => `container fade-in max-w-[800px] mb-16 ${role !== 'seller' ? 'mx-auto pt-2' : 'mx-0 pt-0'}`,
...
export const landingPageStyles = {
  ...
  // Hero section
  heroSection:
    "fade-in items-center justify-center  hero-section pt-4 pb-16 xl:px-40 md:px-20 flex items-center gap-16 overflow-hidden md:flex-col lg:flex-col xl:flex-row max-lg:flex-col max-lg:text-center max-lg:pt-6 max-lg:pb-8 max-lg:px-4 max-lg:gap-8",
  heroContent:
  ...
  featuresContainer:
    "max-w-[1280px] mx-auto px-6 features-container flex gap-24 items-center max-lg:flex-col max-lg:gap-12",
  featuresList:
  ...
  featuresContent: "flex-[0.8] max-w-[450px] max-lg:max-w-full max-lg:w-full",
